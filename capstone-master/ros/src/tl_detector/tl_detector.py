...
class TLDetector(object):
	def __init__(self):
		...
		rospy.loginfo("TLDetector started %s"%rospy.get_time()) #***************
	...
	def get_closest_waypoint(self, pose):
		rospy.loginfo("get_closest_waypoint called %s",1)
		"""
	...
	def get_light_state(self, light):
		rospy.loginfo("get_light_state called %s")#******************************
		"""
		...
		#rospy.loginfo("classifier output =",status)
		rospy.loginfo_throttle(1, status)
		return status

	def process_traffic_lights(self):
		rospy.loginfo("process_traffic_lights called %s")#**********************
		...
		#rospy.loginfo("trafic light ahead %s",light) #**************************
		if light:
